...
mod ppu_tests {
    ...
    fn run_ppu_vbl_nmi_test_and_sprite_overflow(filename: &str) -> Result<(), TestError> {
    ...
    fn blargg_ppu_test_palette_ram() -> Result<(), TestError> {
        run_test("../test_roms/blargg_ppu_tests/palette_ram.nes", 0x00f0)
    }

    #[test]
    fn blargg_ppu_test_power_up_palette() -> Result<(), TestError> {
        run_test("../test_roms/blargg_ppu_tests/power_up_palette.nes", 0x00f0)
    }

    #[test]
    fn blargg_ppu_test_sprite_ram() -> Result<(), TestError> {
        run_test("../test_roms/blargg_ppu_tests/sprite_ram.nes", 0x00f0)
    }
    ...
    fn blargg_ppu_test_vram_access() -> Result<(), TestError> {
        run_test("../test_roms/blargg_ppu_tests/vram_access.nes", 0x00f0)
    }
    ...
    fn ppu_vbl_nmi_test_01_vbl_basics() -> Result<(), TestError> {
        run_ppu_vbl_nmi_test_and_sprite_overflow(
            "../test_roms/ppu_vbl_nmi/rom_singles/01-vbl_basics.nes",
        )
    }
    ...
    fn ppu_vbl_nmi_test_02_vbl_set_time() -> Result<(), TestError> {
        run_ppu_vbl_nmi_test_and_sprite_overflow(
            "../test_roms/ppu_vbl_nmi/rom_singles/02-vbl_set_time.nes",
        )
    }
    ...
    fn ppu_vbl_nmi_test_03_vbl_clear_time() -> Result<(), TestError> {
        run_ppu_vbl_nmi_test_and_sprite_overflow(
            "../test_roms/ppu_vbl_nmi/rom_singles/03-vbl_clear_time.nes",
        )
    }
    ...
    fn ppu_vbl_nmi_test_04_nmi_control() -> Result<(), TestError> {
        run_ppu_vbl_nmi_test_and_sprite_overflow(
            "../test_roms/ppu_vbl_nmi/rom_singles/04-nmi_control.nes",
        )
    }
    ...
    fn ppu_vbl_nmi_test_05_nmi_timing() -> Result<(), TestError> {
        run_ppu_vbl_nmi_test_and_sprite_overflow(
            "../test_roms/ppu_vbl_nmi/rom_singles/05-nmi_timing.nes",
        )
    }
    ...
    fn ppu_vbl_nmi_test_06_suppression() -> Result<(), TestError> {
        run_ppu_vbl_nmi_test_and_sprite_overflow(
            "../test_roms/ppu_vbl_nmi/rom_singles/06-suppression.nes",
        )
    }
    ...
    fn ppu_vbl_nmi_test_07_nmi_on_timing() -> Result<(), TestError> {
        run_ppu_vbl_nmi_test_and_sprite_overflow(
            "../test_roms/ppu_vbl_nmi/rom_singles/07-nmi_on_timing.nes",
        )
    }
    ...
    fn ppu_vbl_nmi_test_08_nmi_off_timing() -> Result<(), TestError> {
        run_ppu_vbl_nmi_test_and_sprite_overflow(
            "../test_roms/ppu_vbl_nmi/rom_singles/08-nmi_off_timing.nes",
        )
    }
    ...
    fn ppu_vbl_nmi_test_09_even_odd_frames() -> Result<(), TestError> {
        run_ppu_vbl_nmi_test_and_sprite_overflow(
            "../test_roms/ppu_vbl_nmi/rom_singles/09-even_odd_frames.nes",
        )
    }
    ...
    fn ppu_vbl_nmi_test_10_even_odd_timing() -> Result<(), TestError> {
        run_ppu_vbl_nmi_test_and_sprite_overflow(
            "../test_roms/ppu_vbl_nmi/rom_singles/10-even_odd_timing.nes",
        )
    }
    ...
    fn ppu_sprite_overflow_test_01_basics() -> Result<(), TestError> {
        run_ppu_vbl_nmi_test_and_sprite_overflow(
            "../test_roms/ppu_sprite_overflow/rom_singles/01-basics.nes",
        )
    }
    ...
    fn ppu_sprite_overflow_test_02_details() -> Result<(), TestError> {
        run_ppu_vbl_nmi_test_and_sprite_overflow(
            "../test_roms/ppu_sprite_overflow/rom_singles/02-details.nes",
        )
    }
    ...
    fn ppu_sprite_overflow_test_03_timing() -> Result<(), TestError> {
        run_ppu_vbl_nmi_test_and_sprite_overflow(
            "../test_roms/ppu_sprite_overflow/rom_singles/03-timing.nes",
        )
    }
    ...
    fn ppu_sprite_overflow_test_04_obscure() -> Result<(), TestError> {
        run_ppu_vbl_nmi_test_and_sprite_overflow(
            "../test_roms/ppu_sprite_overflow/rom_singles/04-obscure.nes",
        )
    }
    ...
    fn ppu_sprite_overflow_test_05_emulator() -> Result<(), TestError> {
        run_ppu_vbl_nmi_test_and_sprite_overflow(
            "../test_roms/ppu_sprite_overflow/rom_singles/05-emulator.nes",
        )
    }
}
