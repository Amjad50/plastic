...
mod mappers_tests {
    ...
    fn holy_mapperel_m0_p32k_c8k_v_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M0_P32K_C8K_V.nes",
            0,
        )
    }
    ...
    fn holy_mapperel_m0_p32k_cr32k_v_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M0_P32K_CR32K_V.nes",
            0,
        )
    }
    ...
    fn holy_mapperel_m0_p32k_cr8k_v_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M0_P32K_CR8K_V.nes",
            0,
        )
    }
    ...
    fn holy_mapperel_m1_p128k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M1_P128K.nes",
            1,
        )
    }
    ...
    fn holy_mapperel_m1_p128k_c128k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M1_P128K_C128K.nes",
            1,
        )
    }
    ...
    fn holy_mapperel_m1_p128k_c32k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M1_P128K_C32K.nes",
            1,
        )
    }
    ...
    fn holy_mapperel_m1_p128k_c32k_s8k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M1_P128K_C32K_S8K.nes",
            1,
        )
    }
    ...
    fn holy_mapperel_m1_p128k_c32k_w8k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M1_P128K_C32K_W8K.nes",
            1,
        )
    }
    ...
    fn holy_mapperel_m1_p128k_cr8k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M1_P128K_CR8K.nes",
            1,
        )
    }
    ...
    fn holy_mapperel_m1_p512k_cr8k_s8k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M1_P512K_CR8K_S8K.nes",
            1,
        )
    }
    ...
    fn holy_mapperel_m1_p512k_s32k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M1_P512K_S32K.nes",
            1,
        )
    }
    ...
    fn holy_mapperel_m1_p512k_s8k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M1_P512K_S8K.nes",
            1,
        )
    }
    ...
    fn holy_mapperel_m2_p128k_cr8k_v_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M2_P128K_CR8K_V.nes",
            2,
        )
    }
    ...
    fn holy_mapperel_m2_p128k_v_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M2_P128K_V.nes",
            2,
        )
    }
    ...
    fn holy_mapperel_m3_p32k_c32k_h_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M3_P32K_C32K_H.nes",
            3,
        )
    }
    ...
    fn holy_mapperel_m4_p128k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M4_P128K.nes",
            4,
        )
    }
    ...
    fn holy_mapperel_m4_p128k_cr32k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M4_P128K_CR32K.nes",
            4,
        )
    }
    ...
    fn holy_mapperel_m4_p128k_cr8k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M4_P128K_CR8K.nes",
            4,
        )
    }
    ...
    fn holy_mapperel_m4_p256k_c256k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M4_P256K_C256K.nes",
            4,
        )
    }
    ...
    fn holy_mapperel_m7_p128k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M7_P128K.nes",
            7,
        )
    }
    ...
    fn holy_mapperel_m7_p128k_cr8k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M7_P128K_CR8K.nes",
            7,
        )
    }
    ...
    fn holy_mapperel_m9_p128k_c64k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M9_P128K_C64K.nes",
            9,
        )
    }
    ...
    fn holy_mapperel_m11_p64k_c64k_v_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M11_P64K_C64K_V.nes",
            11,
        )
    }
    ...
    fn holy_mapperel_m28_p512k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M28_P512K.nes",
            28,
        )
    }
    ...
    fn holy_mapperel_m28_p512k_cr32k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M28_P512K_CR32K.nes",
            28,
        )
    }
    ...
    fn holy_mapperel_m34_p128k_cr8k_h_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M34_P128K_CR8K_H.nes",
            34,
        )
    }
    ...
    fn holy_mapperel_m34_p128k_h_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M34_P128K_H.nes",
            34,
        )
    }
    ...
    fn holy_mapperel_m78_3_p128k_c64k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M78.3_P128K_C64K.nes",
            78,
        )
    }
    ...
    fn holy_mapperel_m118_p128k_c64k_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M118_P128K_C64K.nes",
            118,
        )
    }
    ...
    fn holy_mapperel_m180_p128k_cr8k_h_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M180_P128K_CR8K_H.nes",
            180,
        )
    }
    ...
    fn holy_mapperel_m180_p128k_h_test() -> Result<(), TestError> {
        run_holy_mapperel_test(
            "./tests/roms/holy-mapperel-bin-0.02/testroms/M180_P128K_H.nes",
            180,
        )
    }
}
